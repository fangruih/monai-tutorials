    ...
    for epoch in range(n_epochs):
        ...
        for step, batch in enumerate(train_loader):
            ...
            with autocast(enabled=True):
                ...
                print_gpu_usage()  
                noisy_latent_x = noisy_latent_x[-10].unsqueeze(0)
                ...
                print("noisy_latent_x", noisy_latent_x.shape)
                ...
                print("first_output_latent", first_output_latent.shape)
                del noisy_latent_x
                ...
                noisy_latent_y = noisy_latent_y[-10].unsqueeze(0)
            ...
            with torch.no_grad():
                with autocast(enabled=True):
                    ...
                    for step, batch in enumerate(val_loader):
                        ...
                        # first_output_latent = autoencoder.encode_stage_2_inputs(first_output_latent) * 1.0
